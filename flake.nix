      ...
      let
        overlays = [
          (import ./nix/overlays.nix {
            ...
            src = self;
            llvmVersions = [ 16 18 19 20 21 ];
            gccConstraints = [
              { gccVersion = 13; llvmVersions = [ 16 18 19 20 21 ]; }
              { gccVersion = 14; llvmVersions = [ 16 18 19 20 21 ]; }
              { gccVersion = 15; llvmVersions = [ 16 18 19 20 21 ]; }
            ];
          })
        ];
